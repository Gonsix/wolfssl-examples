...
int main(){
    ...
    printf("Enabled Low Momory Operations \n");

#elif defined(FE_X86_64_FLAG)
    printf("Enabled fast operations for x86_64\n");
#elif defined(FE_ARM64_FLAG)
    printf("Enabled fast operations for Arm64\n");
#else 
    printf("Enabled Normal operations \n");
